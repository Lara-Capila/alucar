...
const CardDetails: FC<CardDetailsProps> = ({ isOpen, closeModal, car }) => (
    ...
    <Dialog as="div" className="relative z-10" onClose={closeModal}>
      ...
      <div className="fixed inset-0">
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] transform rounded-2xl bg-white p-4 text-left shadow-xl transition-all flex flex-col gap-5">
              <button
                type="button"
              ...
              <div className="flex-1 flex flex-col gap-2 overflow-y-auto pr-1">
                ...
                <div className="flex flex-wrap gap-3">
                  {Object.entries(car).map(([key, value]) => (
                    <div className="flex justify-between w-full text-right bg-slate-100 p-2 rounded-md" key={key}>
